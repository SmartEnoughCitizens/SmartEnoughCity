...
/**
 * REST Controller for Simulation operations. Provides endpoints for running impact simulations
...
public class SimulationController {
  ...
  public ResponseEntity<SimulationResponse> runSimulation(
    ...
    log.info(
        "Received simulation request for recommendation ID: {}", request.getRecommendationId());
