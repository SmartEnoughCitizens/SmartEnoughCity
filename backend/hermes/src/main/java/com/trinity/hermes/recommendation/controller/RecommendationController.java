...
public class RecommendationController {
  ...
  //        Optional<RecommendationResponse> updated = recommendationFacade.updateRecommendation(id,
  // request);
  ...
  public ResponseEntity<?> getIndicatorDataForRecommendation(
    ...
    try {
      ...
      log.error("Error fetching indicator data for recommendation engine: {}", e.getMessage(), e);
