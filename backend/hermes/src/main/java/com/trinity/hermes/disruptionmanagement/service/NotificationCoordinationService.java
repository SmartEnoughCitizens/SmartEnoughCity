...
/**
 * Service responsible for coordinating notifications for disruptions. Simplified stub
 * implementation for thin slice.
 */
@Service
...
public class NotificationCoordinationService {
  ...
  public boolean sendDisruptionNotifications(DisruptionSolution solution) {
    ...
    try {
      ...
      log.info(
          "✓ [MOCK] Dashboard notifications sent to transport and city managers about {}",
      ...
      log.error(
          "Error coordinating notifications for disruption {}", solution.getDisruptionId(), e);
      return false;
    }
  }
