...
class TestTrainCalendarScheduleModel:
    ...
    def test_can_create_instance(self, db_session: Session) -> None:
        ...
        result = (
            db_session.query(TrainCalendarSchedule).filter_by(service_id=200).first()
        )
        assert result is not None
...
class TestTrainRouteModel:
    ...
    def test_can_create_with_agency_fk(self, db_session: Session) -> None:
        ...
        route = TrainRoute(
            ...
            agency_id=1,
            short_name="DART",
            long_name="Dublin - Howth/Malahide",
            route_type=2,
            route_color="00A651",
...
class TestTrainTripShapeModel:
    ...
    def test_duplicate_shape_sequence_raises_error(self, db_session: Session) -> None:
        s1 = TrainTripShape(
            shape_id="SH1", pt_sequence=1, pt_lat=53.35, pt_lon=-6.25, dist_traveled=0.0
        )
        s2 = TrainTripShape(
            shape_id="SH1",
            pt_sequence=1,
...
class TestIrishRailStationDataModel:
    ...
    def test_can_create_with_station_fk(self, db_session: Session) -> None:
        ...
        data = IrishRailStationData(
            ...
            destination="Howth",
            origin_time="09:30",
            destination_time="10:45",
            status="En Route",
            last_location="Departed Tara Street",
            due_in=5,
            late=2,
            exp_arrival="10:35",
            exp_depart="10:36",
...
class TestIrishRailTrainMovementModel:
    ...
    def test_can_create_instance(self, db_session: Session) -> None:
        ...
        movement = IrishRailTrainMovement(
            ...
            train_date="22 Jan 2026",
            location_code="CNLLY",
            location_full_name="Connolly",
            location_order=1,
            location_type="O",
            train_origin="Greystones",
            train_destination="Howth",
            scheduled_arrival=None,
            scheduled_departure="09:30:00",
            actual_arrival=None,
            actual_departure="09:31:00",
            auto_arrival=None,
            auto_depart=True,
            stop_type="C",
            fetched_at=now,
