...
const SystemStatus: React.FC = () => {
  ...
  const getOverallStatus = () => {
    ...
    const errorCount = services.filter((s) => (s.status as ServiceStatusType) === 'down' || (s.status as ServiceStatusType) === 'Error').length;
    const warningCount = services.filter((s) => (s.status as ServiceStatusType) === 'maintenance' || (s.status as ServiceStatusType) === 'Warning').length;
